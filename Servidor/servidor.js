...
soap.listen(server, '/crearCatalogo', servicioCatalogo, archivoWSDLCatalogo, function(){
    console.log('Servidor SOAP ejecutandose en http://localhost:7000/crearCatalogo?wsdl'); // El server escucha en la ruta indicada y muestra el archivo WSDL al agregar ?wsdl a la ruta 
});